    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Dialog */}
          <motion.div
            className="relative bg-gray-900 border border-gray-700 rounded-xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Select Course Type</h2>
              <button
                onClick={onClose}
            ...
            <div className="space-y-4">
              {courseTypes.map((courseType) => (
                <motion.button
                  ...
                  className="w-full p-4 border border-gray-700 rounded-lg hover:border-blue-600 hover:bg-gray-800/50 transition-all duration-200 text-left group"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-gray-800 rounded-lg group-hover:bg-blue-600 transition-colors">
                      <courseType.icon className="h-6 w-6 text-white" />
                    </div>
