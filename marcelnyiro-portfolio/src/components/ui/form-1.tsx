...
export default function Example() {
    return (
        <form className="flex flex-col items-center text-sm text-white">
            ...
            <p className="max-md:text-sm text-gray-300 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-white hover:underline">marcel@outfino.com</a>
            </p>
            
            <div className="max-w-96 w-full px-4">
                <label htmlFor="name" className="font-medium">Full Name</label>
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-gray-500 transition-all overflow-hidden">
                ...
                <textarea rows={4} className="w-full mt-2 p-2 bg-transparent border border-slate-300 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-gray-500 transition-all" placeholder="Enter your message" required></textarea>
                
                <button type="submit" className="flex items-center justify-center gap-1 mt-5 bg-black hover:bg-gray-800 text-white py-2.5 w-full rounded-full transition">
                    Submit Form
